...
.DATA
    ...
    limite_rumba db 6   ; tama�o m�ximo de espiral (6 = cubre buen �rea)
    cont_pasos   db 0 
    ...
    val_temp_raw     db 0  
    ; --- C�digos para Traffic Lights ---
    ; Puerto 4 - Word de 16 bits
    
    SEM_ROJO        EQU 0249h   ; Todos los sem�foros en rojo
    SEM_AMARILLO    EQU 0492h   ; Todos los sem�foros en amarillo
    SEM_VERDE       EQU 0924h   ; Todos los sem�foros en verde       
    ...
    msj_error_arc      db 'OCURRIO UN ERROR CON EL ARCHIVO  $' ; Error t�cnico 
